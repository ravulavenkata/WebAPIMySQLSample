...
using WebAPIMySQLSample.Business.Services;

namespace WebAPIMySQLSample.Business.Infrastructure.MessageHandlers
{
    public class InSiteApplicationAuthHandler : DelegatingHandler
    {
